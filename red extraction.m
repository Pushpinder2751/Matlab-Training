...
i_r1=im2bw(i_r,116/225);%filters the red below 116
i_g1=im2bw(i_g,110/225);%filters the green below 116
i_b1=im2bw(i_b,110/225);%filters the blue below 116
i_result=i_r1-i_b1;%subtracts blue from red part
i_result=i_r1-i_g1;%subtracts green from red part
i_result=i_result*255;
i_result=uint8(i_result);
i_result=bwareaopen(i_result,150);
